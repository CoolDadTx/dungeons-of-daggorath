...
using DoD.CommandLine;
using DoD.Graphics;
using DoD.Scheduling;

namespace DoD
{
	public static class GlobalMembers
	{        
        //TODO: Temporary global variables, change to Obsolete after code converted
        ...
        /// <summary></summary>
        /// <remarks>
        /// Could include some command line arguments for various purposes (like configurations) if desired later.
        /// <para />
        ...
        //TODO: Move entry point to Program
  ...
  //          string buffer = new string(new char[256]);
		...
		public static GraphicOptions g_options = GraphicOptions.OptStereo;
		public static CheatCodes g_cheats;
   ...
   //         int x;
        ...
        /// <remarks>
        /// This lets us parse commands like SETOPT GFX NORMAL the SETOPT part is parsed by PretranslateCommand
        /// GFX is the name and NORMAL is the value 
        /// </remarks>
        //C++ TO C# CONVERTER TODO TASK: Pointer arithmetic is detected on the parameter 'char* opt', so pointers on this parameter are left unchanged:
 ...
 //           val[0] = '\0';
  ...
  //          bool bSuccess = false;
		...
		//	if (0 == string.Compare(name, 0, "GFX", 0, nlen) && vlen != 0)
		//	{
		...
		//	} else if (name[0] == 'S')
		//	{
		//		if (nlen > 1 && 0 == string.Compare(name, 1, "ND", 0, nlen - 1) && vlen != 0)
		//		{
		...
		//{
		//		if (nlen > 3 && 0 == string.Compare(name, 3, "GNOREOBJECTS", 0, nlen - 3) && vlen != 0)
		//		{
		//			if (0 == string.Compare(value, 0, "TRUE", 0, vlen))
		//			{
  ...
  //          string name = new string(new char[255]);
		...
		//	else if (name[0] == 'R')
		//	{
		//		if (len > 1 && 0 == string.Compare(name, 1, "ING", 0, len - 1))
		//		{
		...
		//	else if (name[0] == 'I')
		//	{
		//		if (len > 1 && 0 == string.Compare(name, 1, "TEMS", 0, len - 1))
		//		{
