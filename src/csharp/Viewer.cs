...
namespace DoD
{
    /// <summary>This class manages drawing to the screen, including setting up the OpenGL data.  It's a work in progress.</summary>
    /// <remarks>
    ...
    public class Viewer
    {
        ...
        {
            throw new NotImplementedException();
            //         delay1 = delay2 = SDL.SDL_GetTicks();
            ...
            //{
            //	// Set volume of buzz
            //	SDL_mixer.Mix_Volume(fadChannel, ((32 - VCTFAD) / 2) * (oslink.volumeLevel / 16));
            ...
            //	{
            //		// do sound crash
            //		SDL_mixer.Mix_HaltChannel(fadChannel);
            //		SDL_mixer.Mix_Volume(fadChannel, oslink.volumeLevel);
            //		SDL_mixer.Mix_PlayChannel(fadChannel, creature.kaboom, 0);
            //		while (SDL_mixer.Mix_Playing(fadChannel) == 1)
            //		{
            ...
            //		SDL_mixer.Mix_PlayChannel(fadChannel, creature.buzz, -1);
            //	}
            //}
        ...
        /// <summary>This is the renderer method used to do the wizard fade in/out.</summary>
        /// <remarks>
        /// It's only used during the intermission.  It is synchronized with the 30Hz buzz and the wizard crashing sound.
        /// </remarks>
        ...
        /// <summary>This is the renderer method used to do the wizard fade in/out.</summary>
        /// <remarks>
        /// It's only used during the death and victory.  It is synchronized with the 30Hz buzz and the wizard crashing sound.
        /// </remarks>
        public void DeathFade ( int[] WIZ )
        {
            throw new NotImplementedException();
            //         delay1 = SDL.SDL_GetTicks();
        ...
        public void DrawVectorList ( int[] VLA )
        {
            ...
            //	{
            //		if ((g_options & ((int)TaskIds.OptVector | (int)TaskIds.OptHires)) != 0)
            //		{
            //			float x0;
            //			float y0;
            //			float x1;
        ...
        public void DrawVector ( float X0, float Y0, float X1, float Y1 )
        {
            ...
            //	float[] clrLine = Arrays.InitializeWithDefaultInstances<float>(3);
            ...
            //	if ((g_options & (int)TaskIds.OptHires) != 0)
        ...
        /// <param name="fadeMode">Indicates which of the four fades to do.</param>
        /// <remarks>
        /// <list type="table">
        ///   <item>
        ///    <term>1</term>
        ///    <description>Beginning before game starts</description>
        ///   </item>
        ///   <item>
        ///      <term>2</term>
        ///      <description>Intermission after killing wizards image</description>
        ///   </item>
        ///   <item>
        ///      <term>3</term>
        ...
        public bool ShowFade ( int fadeMode )
        {
            ...
            //		while (SDL.SDL_PollEvent(event)) // clear event buffer
            //			;
            ...
            //		// Start buzz
            //		SDL_mixer.Mix_Volume(fadChannel, 0);
            //		SDL_mixer.Mix_PlayChannel(fadChannel, creature.buzz, -1);
        ...
        //TODO: String?
        private char[] textArea = new char[(32 * 4) + 1];

        //TODO: String?
        private char[] examArea = new char[(32 * 19) + 1];

        //TODO: String?
        private char[] statArea = new char[(32 * 1) + 1];

        public Txb TXTPRI = new Txb();
        public Txb TXTEXA = new Txb();
        public Txb TXTSTS = new Txb();

        public float[] bgColor = Arrays.InitializeWithDefaultInstances<float>(3);
        public float[] fgColor = Arrays.InitializeWithDefaultInstances<float>(3);
        public byte RLIGHT;
        public byte MLIGHT;
        public byte OLIGHT;
        public byte VXSCAL;
	...
	//ORIGINAL LINE: int * FWDOBJ[6];
        ...
        private void DrawVectorListAQ ( int[] VLA )
        {
            ...
            //{
            //    glVertex2f(crd.newXa(VLA[ctr]), crd.newYa(VLA[ctr + 1]));
            //    glVertex2f(crd.newXa(VLA[ctr + 2]), crd.newYa(VLA[ctr + 3]));
            //    glVertex2f(crd.newXa(VLA[ctr + 4]), crd.newYa(VLA[ctr + 5]));
            //    glVertex2f(crd.newXa(VLA[ctr + 6]), crd.newYa(VLA[ctr + 7]));
            //    ctr += 8;
            //    ++curQuad;
            //}
            //glEnd();
        ...
        private readonly ushort VCNTRX;
        private readonly ushort VCNTRY;
        private readonly byte OROW;
        private readonly byte OCOL;
        private readonly byte MAGFLG;
        private readonly byte PASFLG;
        private readonly int HLFSCL;
        private readonly int BAKSCL;
        private readonly int NORSCL;
