...
namespace DoD
{
	...
	//C++ TO C# CONVERTER TODO TASK: Variables cannot be declared in if/while/switch conditions in C#:
		...
		// Used by wizard fade in/out function
		public bool KeyHandler(SDL_Keysym keysym)
		{
			bool rc;
		...
		// Used by wizard fade in/out function
		public bool EscHandler(SDL_Keysym keysym)
		{
			bool rc;
	...
	//C++ TO C# CONVERTER NOTE: This was formerly a static local variable declaration (not allowed in C#):
		private bool pause_curState = false;
	//C++ TO C# CONVERTER NOTE: This was formerly a static local variable declaration (not allowed in C#):
	...
	//C++ TO C# CONVERTER NOTE: This static local variable declaration (not allowed in C#) has been moved just prior to the method:
	//	 static uint savedTime;

		 if (!pause_curState
			 && state)
		   pause_savedTime = curTime;
		 else if (pause_curState
			 && !state)
		 {
		   curTime = SDL_GetTicks();
	...
	//C++ TO C# CONVERTER NOTE: Enums must be named in C#, so the following enum has been named AnonymousEnum8:
		...
		public Mix_Chunk[] hrtSound = Arrays.InitializeWithDefaultInstances<Mix_Chunk>(2);
