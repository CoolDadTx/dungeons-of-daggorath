...
namespace DoD.Graphics
{
    ...
    public class OSLink
	{
        ...
        /// <summary>Initializes an instance of the <see cref="OSLink"/> class.</summary>
        public OSLink ()
		{
...
//			memset(gamefile, 0, gamefileLen);
        ...
        /// <para />
        /// Updated - Now defaults to whatever is in the opts.ini file. If opts.ini doesn't exist or has invalid or 
        /// missing values uses defaults set by loadDefaults function (1024x768)
        /// </remarks>
        public void Init()
		{
            throw new NotImplementedException();
 //           Console.Write("Starting OS_Link::init()\n");
   ...
   //         bool end = false;
			...
			//				if (col == DefineConstants.FileMenuSwitch && main_menu_row == DefineConstants.FileMenuNew)
			//					return true;
        ...
        /// <summary>Used to save the options file from current settings.</summary>
        /// <returns><see langword="true"/> if file saved successfully</returns>
   ...
   //         ofstream fout = new ofstream();
		...
		public int width {get; set;} // actual screen width after video setup
		public int height {get; set;} // same for height
		public int volumeLevel {get; set;} // Volume level

		public string gamefile {get; set;} = new string(new char[50]);
		public int gamefileLen {get; set;}
		public string pathSep {get; set;} = new string(new char[2]);

        //TODO: Don't store this
		public FileStream fptr {get; set;}
		public string confDir {get; set;} = new string(new char[5]);
		public string soundDir {get; set;} = new string(new char[6]);
		public string savedDir {get; set;} = new string(new char[DefineConstants.MaxFilenameLength + 1]);
		public byte[] keys {get; set;} = new byte[256];
		public int keylayout {get; set;} // 0 = QWERTY, 1 = Dvorak
		public int keyLen {get; set;}
        public int audio_rate {get; set;}
		public ushort audio_format {get; set;}
		public int audio_channels {get; set;}
		public int audio_buffers {get; set;}

        #region SDL 2.0 changes
		...
		/// <summary>Process menu commands.</summary>
        /// <returns><see langword="false"/> if menu should be redrawn.</returns>
        ...
        /// <summary>Draw a list, move among that list, and return the item selected.</summary>
        ...
        /// <summary>Draw a box for a string entry, then return it.</summary>
        ...
        /// <summary>Draw a scrollbar, and return the value.</summary>
        /// <param name="title">The title of the entry.</param>
		...
		/// <summary>Load & parse options file.</summary>
		private void LoadOptFile()
		{
            ...
            //	if (breakPoint != null || breakPoint == inputString || breakPoint == (inputString.Substring(inputString.Length) - 1))
            //	{
            //		(breakPoint) = '\0';
		...
		/// <summary>Load the options file from current settings.</summary>		
		...
		/// <summary>Swap fullscreen mode.</summary>
        ...
        /// <summary>Change the video resolution.</summary>
